    ...
    public partial class Login : ContentPage
    {
        ...
        private async void Ingresar_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                MainPage.usuarioLogeado = UsuarioValidado;
                await Navigation.PopAsync(false);

                await DisplayAlert("Bienvenido " + MainPage.usuarioLogeado.NombreYApellido , "Nos alegra que nos visites nuevamente.", "Continuar");
